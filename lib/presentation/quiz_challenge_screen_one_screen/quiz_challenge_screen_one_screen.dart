import '../quiz_challenge_screen_one_screen/widgets/listlocation1_item_widget.dart';
...
class QuizChallengeScreenOneScreen extends StatelessWidget {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarTitle(text: "Python Quiz")),
            body: SizedBox(
                width: size.width,
                child: SingleChildScrollView(
                    child: Padding(
                        padding: getPadding(left: 19, right: 11, bottom: 5),
                        child: Column(
                                                          ...
                                                          child: ListView
                                                              .separated(
                                                                  ...
                                                                  itemBuilder:
                                                                      (context,
                                                                          index) {
                                                                    return Listlocation1ItemWidget();
                                                                  }))
                                                    ]))),
                                        Align(
                                            alignment: Alignment.topCenter,
