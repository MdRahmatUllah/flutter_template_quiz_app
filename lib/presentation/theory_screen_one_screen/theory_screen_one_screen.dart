...
class TheoryScreenOneScreen extends StatelessWidget {
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Container(
                              margin: getMargin(left: 2, top: 18, right: 1),
                              padding: getPadding(
                      ...
                      Container(
                          ...
                          child: Container(
                              width: getHorizontalSize(326),
                              margin: getMargin(left: 2, top: 10, right: 1),
                              padding: getPadding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Padding(
                                        padding: getPadding(top: 4),
                                        child: Text("x = 4 # x is of type int",
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                                                .txtRobotoRegular14Black900
                                                .copyWith(
                                                    letterSpacing:
                                                        getHorizontalSize(
                                                            0.04)))),
                                    Text("x = \"Sally\" # x is now of type str",
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                                        style: AppStyle
                                            .txtRobotoRegular14Black900
